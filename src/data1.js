...
export const product_data = [
...

  {
    ...
    product_details: {
      ...
      "Noise leval (7 meter away dB)": "≤66",
      "Rated frequency (Hz)": "50/60",
      "Rated voltage (V)": "220/120",
      "Dimension (mm)": "615x460x490",
      "N.Weight /G.weight (kg)": "48/51",
      "QTY into one 40ft container": 475,
      option:
        "Option: E-start + Battery , Wheel,Handle, Stand feet , Pallets with shrink film 100% COPPER WIRE USED,100% TESTED,100% WARRANTY SUPPORT,18 YEARS PRODUCING EXPERIENCES, VOTAN BRING YOUR BETTER LIFE!",
    },
    Gasoline_Generators: "",
  },
  {
    ...
    product_details: {
      ...
      "Max. Power (KW)": "2.8KW",
      "Engine type": "4-stroke, Single Cylinder, forced Air-cooled",
      "Bore x Stroke (mm)": "70×54",
      "Displacement (ml)": 207,
      "Ignition system": "Non-contact transistor",
      "Start system": "Recoil/ Electric start",
      "Fuel tank Capacity (L)": 20,
      "Oil Capacity (L)": 0.6,
      "Fuel consumption (L/Hr)": 1.25,
      "Continuous running (Hrs)": 13,
      "Noise leval (7 meter away dB)": "≤67",
      "Rated frequency (Hz)": "50/60",
      "Rated voltage (V)": "220/120",
      "Rated power (KW)": "2.5",
      "Max. power (KW)": "2.7",
      "Dimension (mm)": "615×460×490",
      "N.Weight /G.weight (kg)": "49/52",
      "QTY into one 40ft container": 475,
      Option:
        "E-start + Battery , Wheel,Handle, Stand feet , Pallets with shrink film",
    },
    additional_info: {
      "COPPER WIRE USED": "100%",
      TESTED: "100%",
      "WARRANTY SUPPORT": "100%",
      "PRODUCING EXPERIENCES": "18 YEARS",
      VOTAN: "BRING YOUR BETTER LIFE!",
    },
    Gasoline_Generators: "",
  },
  {
    ...
    product_details: {
      ...
      "Net Weight": "100KGS",
      option:
        "We can supply Chinese brands 4-stroke outboard motor 2.5HP, 4HP, 6HP, 8HP, 9.9HP, 15HP, 25HP, 30HP with inflatable boat together at good price also well",
    },
    Inflatable_Boat: "",
  },

  {
    ...
    product_details: {
      ...
      "Standard boat accessories": 
        "Foot pump, Oars, Seat, Carry bag, Repair kits"
      ,
  ...
  },
  {
    ...
    product_details: {
      ...
      "Tube Diameter": "330mm",
      "Max person": "2",
      "Engine power": "2.5HP / 4HP (optional )",
      "Net Weight": "38KGS",
      "Available on the Plywood, aluminum, Air deck bottom by optional.": true,
      "PVC ply": "0.9MM",
      "PVC colors option": "White, grey, red, blue, yellow etc.",
      "Outboard engine": {
        Model: "4-stroke 2.5HP / 4HP",
        "Max. Output": "1.8KW(2.5HP) / 2.9KW(4HP)",
        "Full throttle operating Range":
          "5250- 5750rpm (2.5HP) / 4000-5000rpm(4HP)",
        Stroke: 4,
        Cylinder: 1,
        Displacement: "72cc (2.5HP) / 112cc(4HP)",
        "Bore X Stroke": "54*31.5mm(2.5HP) / 59*41(4HP)",
        "Length X Width X Height":
          "623*345*1021mm(2.5HP) / 717*361*1029mm (4HP)",
        Weight: "17kgs(2.5HP) / 22kgs ( 4HP )",
        "Gear Ratio": "2.08(27/13)",
        "Gear Shift Position": "F-N(2.5HP ) / F-N-R (4HP)",
        "Ignition System": "TCI",
        "Cooling System": "Water - Cooling",
        "Starting System": "Manual",
        "Control System": "Tiller Control",
        "Capacity Of Fuel Tank": "0.9L (2.5HP ) / 1.1L ( 4HP)",
  ...
  },
  {
    ...
    product_details: {
      ...
      "Outboard engine": {
        ...
        "Length X Width X Height": {
          "Short shaft": "1000x427x1080mm",
          "Long short": "1000x427x1207mm",
        },
        Weight: {
          "Short shaft": "45kgs",
          "Long shaft": "47kgs",
  ...
  },
  {
    ...
    product_details: {
      ...
      "RIB Boat New model RIB390": {
        ...
        "Tube Diameter": 440,
        "Max person": 5,
        "Engine power": "SAIL 15HP /30HP/40HP",
        "Net Weight": "120kgs",
        "Box size": "360 x 130 x 60CM",
        "Come with": [
          "Foot pump",
          "Oars",
          "repair kits",
          "fiber glass center console",
          "soft seat",
          "stainless steel hand holder",
        ],
        Brand: "SAIL or OEM",
      },
      "Outboard motor":
  ...
  },
  {
    ...
    product_details: {
      ...
      "More Standard accessory":
        "The boat comes with foot pump, two sets of oars, a repair kit, fiber glass console with wind screen, real comfortable seats and back support, soft and comfortable cushion for lying in front of the boat, and two built-in fuel tanks (300L total), one water tank (100L), fiber glass anchor tray, rubber handle, fiber glass roll bar, stainless steel hang ring, holder ring for water skiing etc.",
    },
    "RIB Boat": "",
  },
  {
